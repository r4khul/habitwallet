...
mixin _$NotificationSettings {
 ...
 bool get isEnabled; String get reminderTimeStr;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NotificationSettings&&(identical(other.isEnabled, isEnabled) || other.isEnabled == isEnabled)&&(identical(other.reminderTimeStr, reminderTimeStr) || other.reminderTimeStr == reminderTimeStr));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,isEnabled,reminderTimeStr);

@override
String toString() {
  return 'NotificationSettings(isEnabled: $isEnabled, reminderTimeStr: $reminderTimeStr)';
}
...
@useResult
$Res call({
 bool isEnabled, String reminderTimeStr
});
...
/// Create a copy of NotificationSettings
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isEnabled = null,Object? reminderTimeStr = null,}) {
  return _then(_self.copyWith(
isEnabled: null == isEnabled ? _self.isEnabled : isEnabled // ignore: cast_nullable_to_non_nullable
as bool,reminderTimeStr: null == reminderTimeStr ? _self.reminderTimeStr : reminderTimeStr // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isEnabled,  String reminderTimeStr)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationSettings() when $default != null:
return $default(_that.isEnabled,_that.reminderTimeStr);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isEnabled,  String reminderTimeStr)  $default,) {final _that = this;
switch (_that) {
case _NotificationSettings():
return $default(_that.isEnabled,_that.reminderTimeStr);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isEnabled,  String reminderTimeStr)?  $default,) {final _that = this;
switch (_that) {
case _NotificationSettings() when $default != null:
return $default(_that.isEnabled,_that.reminderTimeStr);case _:
  return null;
...
class _NotificationSettings extends NotificationSettings {
  const _NotificationSettings({this.isEnabled = false, this.reminderTimeStr = '20:00'}): super._();
  factory _NotificationSettings.fromJson(Map<String, dynamic> json) => _$NotificationSettingsFromJson(json);

@override@JsonKey() final  bool isEnabled;
@override@JsonKey() final  String reminderTimeStr;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _NotificationSettings&&(identical(other.isEnabled, isEnabled) || other.isEnabled == isEnabled)&&(identical(other.reminderTimeStr, reminderTimeStr) || other.reminderTimeStr == reminderTimeStr));
}
...
/// Create a copy of NotificationSettings
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isEnabled = null,Object? reminderTimeStr = null,}) {
