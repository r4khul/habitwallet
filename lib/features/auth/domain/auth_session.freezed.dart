...
mixin _$AuthSession {
 ...
 String get email; bool get rememberMe;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthSession&&(identical(other.email, email) || other.email == email)&&(identical(other.rememberMe, rememberMe) || other.rememberMe == rememberMe));
}


@override
int get hashCode => Object.hash(runtimeType,email,rememberMe);

@override
String toString() {
  return 'AuthSession(email: $email, rememberMe: $rememberMe)';
}
...
/// Create a copy of AuthSession
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? email = null,Object? rememberMe = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String email,  bool rememberMe)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthSession() when $default != null:
return $default(_that.email,_that.rememberMe);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String email,  bool rememberMe)  $default,) {final _that = this;
switch (_that) {
case _AuthSession():
return $default(_that.email,_that.rememberMe);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String email,  bool rememberMe)?  $default,) {final _that = this;
switch (_that) {
case _AuthSession() when $default != null:
return $default(_that.email,_that.rememberMe);case _:
  return null;
...
class _AuthSession implements AuthSession {
  const _AuthSession({required this.email, required this.rememberMe});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AuthSession&&(identical(other.email, email) || other.email == email)&&(identical(other.rememberMe, rememberMe) || other.rememberMe == rememberMe));
}
...
/// Create a copy of AuthSession
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? email = null,Object? rememberMe = null,}) {
